    ...
    internal partial class MenuStrip : ContextMenuStrip
    {
        ...
        internal void SetDataType(Type dataType)
        {
            ...
            if (dataType == typeof(DateTime) || dataType == typeof(TimeSpan))
            {
                ...
                sortASCMenuItem.Image = EnterpriseSolutionBIDesktop.Properties.Resources.MenuStrip_OrderASCnum;
                sortDESCMenuItem.Image = EnterpriseSolutionBIDesktop.Properties.Resources.MenuStrip_OrderDESCnum;
            }
            else if (dataType == typeof(bool))
            {
                customFilterLastFiltersListMenuItem.Text = AdvancedDataGridView.Translations[AdvancedDataGridView.TranslationKey.ADGVCustomFilter.ToString()];
                ...
                sortASCMenuItem.Image = EnterpriseSolutionBIDesktop.Properties.Resources.MenuStrip_OrderASCbool;
                sortDESCMenuItem.Image = EnterpriseSolutionBIDesktop.Properties.Resources.MenuStrip_OrderDESCbool;
            }
            ...
            else
            {
                ...
                sortASCMenuItem.Image = EnterpriseSolutionBIDesktop.Properties.Resources.MenuStrip_OrderASCtxt;
                sortDESCMenuItem.Image = EnterpriseSolutionBIDesktop.Properties.Resources.MenuStrip_OrderDESCtxt;
            }
        ...
        {
            e.Graphics.DrawImage(EnterpriseSolutionBIDesktop.Properties.Resources.MenuStrip_ResizeGrip, 0, 0);
        }
