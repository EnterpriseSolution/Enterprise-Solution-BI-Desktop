...
namespace Zuby.ADGV
{
    ...
    internal class ColumnHeaderCell : DataGridViewColumnHeaderCell
    {
        ...
        private Image _filterImage = EnterpriseSolutionBIDesktop.Properties.Resources.ColumnHeader_UnFiltered;
        ...
        private void RefreshImage()
        {
            ...
            {
                _filterImage = EnterpriseSolutionBIDesktop.Properties.Resources.ColumnHeader_SavedFilters;
            }
            else
            {
                if (ActiveFilterType == MenuStrip.FilterType.None)
                {
                    if (ActiveSortType == MenuStrip.SortType.None)
                        _filterImage = EnterpriseSolutionBIDesktop.Properties.Resources.ColumnHeader_UnFiltered;
                    else if (ActiveSortType == MenuStrip.SortType.ASC)
                        _filterImage = EnterpriseSolutionBIDesktop.Properties.Resources.ColumnHeader_OrderedASC;
                    else
                        _filterImage = EnterpriseSolutionBIDesktop.Properties.Resources.ColumnHeader_OrderedDESC;
                }
                else
                {
                    if (ActiveSortType == MenuStrip.SortType.None)
                        _filterImage = EnterpriseSolutionBIDesktop.Properties.Resources.ColumnHeader_Filtered;
                    else if (ActiveSortType == MenuStrip.SortType.ASC)
                        _filterImage = EnterpriseSolutionBIDesktop.Properties.Resources.ColumnHeader_FilteredAndOrderedASC;
                    else
                        _filterImage = EnterpriseSolutionBIDesktop.Properties.Resources.ColumnHeader_FilteredAndOrderedDESC;
                }
            }
        }
